<footer class="site-footer">
  <div class="wrap footer-grid">
    ...
    <div class="footer-brand">
      ...
      <div class="footer-social">
        <?php $gh_url = esp32_get( 'github_url', 'https://github.com/abdulmubeen7876773-dotcom/esp32' ); if ( $gh_url ) : ?>
        <a href="<?php echo esc_url( $gh_url ); ?>" rel="noopener noreferrer" target="_blank" aria-label="GitHub">
        ...
        <?php endif; $yt_url = esp32_get( 'youtube_url', 'https://www.youtube.com/@ESP32Engine' ); if ( $yt_url ) : ?>
        <a href="<?php echo esc_url( $yt_url ); ?>" rel="noopener noreferrer" target="_blank" aria-label="YouTube">
  ...
  <div class="wrap footer-bottom">
    <p>© <?php echo esc_html( gmdate( 'Y' ) ); ?> <?php echo esc_html( esp32_get( 'footer_name', 'ESP32 Engine' ) ); ?>. All rights reserved.</p>
  </div>
</footer>
